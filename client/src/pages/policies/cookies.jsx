...
export function Cookies(){
    return (
        ...
        <div className="card" style={{width: '80%'}}>
            <h1>Cookie Policy for Associated pools Incorporated's Website</h1>

            <p>This is the Cookie Policy for Associated pools Incorporated's Website, accessible from https://www.associatedpoolsinc.com</p>
            ...
            <ul>
            <li>Email: info@associatedpoolsinc.com</li>
